        ...
        ?>
          <tr>
            ...
            <td>
              ...
              <a class="btn btn-warning" href="index.php?quanly=suanhom&id=<?php echo  $row['id_nhom'] ?>">Sửa</a>||
              <a class="btn btn-info" href="index.php?quanly=xemthanhvien&id=<?php echo  $row['id_nhom'] ?>">Thành viên</a>
            </td>
          </tr>
        <?php } ?>
      </tbody>
