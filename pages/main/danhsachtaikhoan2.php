        ...
        <div class="col-lg-6">
            <form class="form-inline" action="index.php?quanly=timkiemnhom" method="POST">
                <div class="input-group w-100">
                    <input type="search" name="tukhoa" class="form-control" placeholder="Nhập tên nhóm "
                        aria-label="Search">
...
<div class="container mt-4">
    <h6 style="text-align: center; text-transform: uppercase; font-weight: bold;">Liệt kê danh sách nhân viên đã nghỉ</h6>
                ...
                echo 'Nghỉ việc';
                    ...
                    <td>
                        <a class="btn btn-danger"
                            href="xuly/xulythemnhanvien.php?id=<?php echo  $row['id_nhanvien'] ?>">Xóa</a>
                    </td>
                </tr>
                <?php }} ?>
            </tbody>
